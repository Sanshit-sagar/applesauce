...
const LeftAlignIcon = () => <i class="ri-align-left"></i>
const RightAlignIcon = () => <i class="ri-align-right"></i>
const CenterAlignIcon = () => <i class="ri-align-center"></i>
const JustifyIcon = () => <i class="ri-align-justify"></i>
