...
const AlignLeftIcon = () => <i class="ri-align-left"></i>
const AlignRightIcon = () => <i class="ri-align-right"></i>
const AlignCenterIcon = () => <i class="ri-align-center"></i>
const AlignJustifyIcon = () => <i class="ri-align-justify"></i>
